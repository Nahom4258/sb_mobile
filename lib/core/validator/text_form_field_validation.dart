...
String? validateFirstName(String? fullName, BuildContext context) {
  var localizedContext = context;
  if (fullName == null || fullName.isEmpty) {
    return AppLocalizations.of(localizedContext)!.first_name_is_required;
...
String? validateLastName(String? fullName, BuildContext context) {
  var localizedContext = context;
  if (fullName == null || fullName.isEmpty) {
    return AppLocalizations.of(localizedContext)!.last_name_is_required;
  } else if (fullName.length < 3) {
    return AppLocalizations.of(localizedContext)!
...
String? validateCustomContestName(String? val, BuildContext context) {
  var localizedContext = context;
  if (val == null || val.trim().isEmpty) {
    return AppLocalizations.of(localizedContext)!.please_enter_contest_name;
  }
  return null;
}

String? validateCustomContestDescription(String? val, BuildContext context) {
  var localizedContext = context;
  if (val == null || val.trim().isEmpty) {
    return AppLocalizations.of(localizedContext)!
        .please_enter_contest_description;
  }
  return null;
}
