...
RouteBase get $firstNamePageRoute => GoRouteData.$route(
      path: '/firstName',
      name: 'firstName',
      factory: $FirstNamePageRouteExtension._fromState,
    );

extension $FirstNamePageRouteExtension on FirstNamePageRoute {
  static FirstNamePageRoute _fromState(GoRouterState state) =>
      FirstNamePageRoute();
...
RouteBase get $homePageRoute => GoRouteData.$route(
      ...
      routes: [
        ...
        GoRouteData.$route(
          ...
          routes: [
            ...
            GoRouteData.$route(
              path: 'cashout',
              name: 'cashout',
              factory: $CashoutPageRouteExtension._fromState,
            ),
            GoRouteData.$route(
              path: 'friends',
              name: 'friends',
              ...
              routes: [
                GoRouteData.$route(
                  ...
                  routes: [
                    GoRouteData.$route(
                      ...
                      factory: $FriendsDetailFromAddFriendsPageRouteExtension
                          ._fromState,
                    ),
                  ],
                ),
                GoRouteData.$route(
                  path: 'freindsDetail',
                  name: 'friendsdetail',
                  factory: $FriendsDetailPageRouteExtension._fromState,
                ),
              ],
            ),
          ],
        ...
        GoRouteData.$route(
          ...
          routes: [
            ...
            GoRouteData.$route(
              path: 'channelVideos',
              name: 'channelVideos',
              factory: $ChannelVideosPageRouteExtension._fromState,
            ),
            GoRouteData.$route(
        ...
        GoRouteData.$route(
          ...
          factory: $CustomContestMainPageRouteExtension._fromState,
          routes: [
            GoRouteData.$route(
              path: 'customContestCreatePage',
              name: 'customContestCreatePage',
              factory: $CustomContestCreatePageRouteExtension._fromState,
            ),
            GoRouteData.$route(
              path: 'customContestDetailPage/:customContestId',
              name: 'customContestDetailPage',
              factory: $CustomContestDetailPageRouteExtension._fromState,
              routes: [
                GoRouteData.$route(
                  path: 'customContestUpdatePage',
                  name: 'customContestUpdatePage',
                  factory: $CustomContestUpdatePageRouteExtension._fromState,
                ),
                GoRouteData.$route(
                  path: 'categoryQuestions',
                  name: 'customContestQuestionByCategory',
                  factory: $CustomContestQuestionByCategoryPageRouteExtension
                      ._fromState,
                  routes: [
                    GoRouteData.$route(
                      path: 'content',
                      ...
                      factory:
                          $CustomContestToContentPageRouteExtension._fromState,
                    ),
                    GoRouteData.$route(
                      path: 'chat',
                      name: 'customContestChatWithAI',
                      factory:
                          $CustomContestQuestionByCategoryChatWithAIPageRouteExtension
                              ._fromState,
                    ),
                  ],
                ),
                GoRouteData.$route(
                  ...
                  factory:
                      $CustomContestInviteFriendsPageRouteExtension._fromState,
                  routes: [
                    GoRouteData.$route(
                      path: 'customContestAddFriendsPage',
                      name: 'customContestAddFriendsPage',
                      factory:
                          $CustomContestAddFriendsPageRouteExtension._fromState,
                    ),
                  ],
                ),
              ],
        ...
        GoRouteData.$route(
          ...
          factory: $NotificationsPageRouteExtension._fromState,
        ),
        GoRouteData.$route(
          path: 'learningPathRoute',
          factory: $LearningPathPageRouteExtension._fromState,
        ),
      ],
    );
...
extension $CashoutPageRouteExtension on CashoutPageRoute {
  static CashoutPageRoute _fromState(GoRouterState state) => CashoutPageRoute();
...
extension $FriendsDetailFromAddFriendsPageRouteExtension
    on FriendsDetailFromAddFriendsPageRoute {
  static FriendsDetailFromAddFriendsPageRoute _fromState(GoRouterState state) =>
      FriendsDetailFromAddFriendsPageRoute(
        userId: state.queryParameters['user-id']!,
      );

  String get location => GoRouteData.$location(
        '/profile/friends/addFriends/freindsDetailFromAddFriends',
        queryParams: {
          'user-id': userId,
        },
      );
...
extension $FriendsDetailPageRouteExtension on FriendsDetailPageRoute {
  static FriendsDetailPageRoute _fromState(GoRouterState state) =>
      FriendsDetailPageRoute(
        userId: state.queryParameters['user-id']!,
      );

  String get location => GoRouteData.$location(
        '/profile/friends/freindsDetail',
        queryParams: {
          'user-id': userId,
        },
      );
...
extension $ChannelVideosPageRouteExtension on ChannelVideosPageRoute {
  static ChannelVideosPageRoute _fromState(GoRouterState state) =>
      ChannelVideosPageRoute(
        courseId: state.pathParameters['courseId']!,
        channelId: state.queryParameters['channel-id']!,
        channelName: state.queryParameters['channel-name']!,
        channelDescritption: state.queryParameters['channel-descritption']!,
        channelSubscribersCount:
            int.parse(state.queryParameters['channel-subscribers-count']!),
        channelUrl: state.queryParameters['channel-url']!,
      );

  String get location => GoRouteData.$location(
        '/course/${Uri.encodeComponent(courseId)}/channelVideos',
        queryParams: {
          'channel-id': channelId,
          'channel-name': channelName,
          'channel-descritption': channelDescritption,
          'channel-subscribers-count': channelSubscribersCount.toString(),
...
extension $VideoPlayerPageRouteExtension on VideoPlayerPageRoute {
  static VideoPlayerPageRoute _fromState(GoRouterState state) =>
      VideoPlayerPageRoute(
        ...
        lastStartedSubChapterId:
            state.queryParameters['last-started-sub-chapter-id'],
        $extra: state.extra as List<SubchapterVideo>,
      );
...
extension $CustomContestMainPageRouteExtension on CustomContestMainPageRoute {
  static CustomContestMainPageRoute _fromState(GoRouterState state) =>
      CustomContestMainPageRoute();

  String get location => GoRouteData.$location(
        '/customContestMainPage',
      );
...
extension $CustomContestCreatePageRouteExtension
    on CustomContestCreatePageRoute {
  static CustomContestCreatePageRoute _fromState(GoRouterState state) =>
      CustomContestCreatePageRoute();

  String get location => GoRouteData.$location(
        '/customContestMainPage/customContestCreatePage',
      );
...
extension $CustomContestDetailPageRouteExtension
    on CustomContestDetailPageRoute {
  static CustomContestDetailPageRoute _fromState(GoRouterState state) =>
      CustomContestDetailPageRoute(
        customContestId: state.pathParameters['customContestId']!,
      );

  String get location => GoRouteData.$location(
        '/customContestMainPage/customContestDetailPage/${Uri.encodeComponent(customContestId)}',
      );
...
extension $CustomContestUpdatePageRouteExtension
    on CustomContestUpdatePageRoute {
  static CustomContestUpdatePageRoute _fromState(GoRouterState state) =>
      CustomContestUpdatePageRoute(
        customContestId: state.pathParameters['customContestId']!,
        $extra: state.extra as CustomContestDetail?,
      );

  String get location => GoRouteData.$location(
        '/customContestMainPage/customContestDetailPage/${Uri.encodeComponent(customContestId)}/customContestUpdatePage',
      );
...
extension $CustomContestQuestionByCategoryPageRouteExtension
    on CustomContestQuestionByCategoryPageRoute {
  static CustomContestQuestionByCategoryPageRoute _fromState(
          GoRouterState state) =>
  ...
  String get location => GoRouteData.$location(
        '/customContestMainPage/customContestDetailPage/${Uri.encodeComponent(customContestId)}/categoryQuestions',
      );
...
extension $CustomContestToContentPageRouteExtension
    on CustomContestToContentPageRoute {
  static CustomContestToContentPageRoute _fromState(GoRouterState state) =>
  ...
  String get location => GoRouteData.$location(
        '/customContestMainPage/customContestDetailPage/${Uri.encodeComponent(customContestId)}/categoryQuestions/content',
        queryParams: {
          'course-id': courseId,
        },
      );
...
extension $CustomContestQuestionByCategoryChatWithAIPageRouteExtension
    on CustomContestQuestionByCategoryChatWithAIPageRoute {
  static CustomContestQuestionByCategoryChatWithAIPageRoute _fromState(
          GoRouterState state) =>
  ...
  String get location => GoRouteData.$location(
        '/customContestMainPage/customContestDetailPage/${Uri.encodeComponent(customContestId)}/categoryQuestions/chat',
      );
...
extension $CustomContestInviteFriendsPageRouteExtension
    on CustomContestInviteFriendsPageRoute {
  static CustomContestInviteFriendsPageRoute _fromState(GoRouterState state) =>
      CustomContestInviteFriendsPageRoute(
        customContestId: state.pathParameters['customContestId']!,
      );

  String get location => GoRouteData.$location(
        '/customContestMainPage/customContestDetailPage/${Uri.encodeComponent(customContestId)}/customContestInviteFriendsPage',
      );
...
extension $CustomContestAddFriendsPageRouteExtension
    on CustomContestAddFriendsPageRoute {
  static CustomContestAddFriendsPageRoute _fromState(GoRouterState state) =>
      CustomContestAddFriendsPageRoute(
        customContestId: state.pathParameters['customContestId']!,
      );

  String get location => GoRouteData.$location(
        '/customContestMainPage/customContestDetailPage/${Uri.encodeComponent(customContestId)}/customContestInviteFriendsPage/customContestAddFriendsPage',
      );
...
extension $NotificationsPageRouteExtension on NotificationsPageRoute {
  static NotificationsPageRoute _fromState(GoRouterState state) =>
...
extension $LearningPathPageRouteExtension on LearningPathPageRoute {
  static LearningPathPageRoute _fromState(GoRouterState state) =>
