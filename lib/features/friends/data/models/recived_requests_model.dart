...
class RecievedRequestsModel extends FriendEntity {
  const RecievedRequestsModel({
    required super.id,
  ...
  factory RecievedRequestsModel.fromJson(Map<String, dynamic> json) {
    return RecievedRequestsModel(
      id: json['_id'] ?? '',
