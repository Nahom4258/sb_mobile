...
class GetRecivedRequestsUsecase extends UseCase<List<FriendEntity>, NoParams> {
  final FriendsRepositories friendsRepo;

  GetRecivedRequestsUsecase({required this.friendsRepo});
  @override
  Future<Either<Failure, List<FriendEntity>>> call(NoParams params) async {
    return await friendsRepo.getRecivedRequests();
  }
}
