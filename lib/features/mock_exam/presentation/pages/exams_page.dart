...
class ExamsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var examCardParams = <ExamCardParams>[
      ...
      ExamCardParams(
        cardBackgroundColor: const Color(0xFFFFE9CF),
        title: AppLocalizations.of(context)!.downloaded_exams,
        description:
            AppLocalizations.of(context)!.get_access_to_downloaded_exams,
        imageAddress: 'assets/images/downloaded_mock.png',
        onPressed: () {
