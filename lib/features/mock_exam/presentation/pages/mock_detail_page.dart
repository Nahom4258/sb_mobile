...
class _MockDetailPageState extends State<MockDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<AlertDialogBloc, AlertDialogState>(
      ...
      child: Scaffold(
        appBar: AppBar(
          title:Text(AppLocalizations.of(context)!.national_exam),
          leading: IconButton(
            onPressed: () {
              context.pop();
            },
                                  ...
                                  ? Row(
                                      children: [
                                        MockButton(
                                          ...
                                          buttonText: AppLocalizations.of(context)!.start_exam,
                                  ...
                                  : Row(
                                      children: [
                                        MockButton(
                                          ...
                                          buttonText: AppLocalizations.of(context)!.mock_anlysis,
                                          bgColor: const Color(0xFF1A7A6C),
                                          textColor: Colors.white,
                                        ),
                                        const SizedBox(width: 8),
                                        MockButton(
                                          ...
                                          buttonText:AppLocalizations.of(context)!.retake_exam ,
                                ...
                                if (state is DownloadMockByIdLoaded) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      ...
                                      content: Text(
                                        AppLocalizations.of(context)!.mock_downloaded_succesfully,
                                        style: GoogleFonts.poppins(
                                          color: Colors.white,
                                        ),
                                      ),
