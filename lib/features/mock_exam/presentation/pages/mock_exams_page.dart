  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          widget.isStandard
              ? AppLocalizations.of(context)!.university_entrance_exams
              : AppLocalizations.of(context)!.ai_generated_exams,
                  ...
                  child: BlocBuilder<MockExamBloc, MockExamState>(
                    builder: (context, state) {
                      if (state is GetDepartmentMocksState &&
                        ...
                        if (mocks.isEmpty) {
                          return const EmptyListWidget(icon: 'assets/images/emptypage.svg',message: 'No mocks');
                        }
