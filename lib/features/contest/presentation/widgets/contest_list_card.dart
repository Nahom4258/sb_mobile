            ...
            Column(
              ...
              children: [
                SizedBox(
                  width: 60.w,
                  child: Text(
                    isLiveContest ? liveContest!.title : contest!.title,
                    style: TextStyle(
                      fontFamily: 'Poppins',
                      fontSize: 16,
                ...
                SizedBox(height: 1.h),
                Text(
                  DateFormat('MMM dd, yyyy hh:mmaa').format(isLiveContest ? liveContest!.startsAt : contest!.startsAt),
                  // 'Dec 15, 2023 08:00PM',
                  style: TextStyle(
                    fontFamily: 'Poppins',
