...
class AuthenticationRepositoryImpl extends AuthenticationRepository {
  ...
  Future<Either<Failure, UserCredential>> signInWithGoogle() async {
    if (await networkInfo.isConnected) {
      String? referredBy = await localDatasource.getReferralId();
      try {
...
// Apple Sign In
  ...
  @override
  Future<Either<Failure, Unit>> logoutWithApple() async {
    if (await networkInfo.isConnected) {
      try {
  ...
  @override
  Future<Either<Failure, bool>> isAuthenticatedWithApple() async {
    if (await networkInfo.isConnected) {
      final isAuthenticatedWithGoogle =
          await AuthenticationWithGoogle.isAuthenticatedWithGoogle();
      return Right(isAuthenticatedWithGoogle);
