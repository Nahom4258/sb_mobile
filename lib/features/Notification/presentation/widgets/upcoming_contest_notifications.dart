...
class UpcomingContestNotificationWidget extends StatefulWidget {
  const UpcomingContestNotificationWidget({
    super.key,
  ...
  @override
  State<UpcomingContestNotificationWidget> createState() =>
      _UpcomingContestNotificationWidgetState();
}

class _UpcomingContestNotificationWidgetState
    extends State<UpcomingContestNotificationWidget> {
                ...
                Row(
                  ...
                  children: [
                    SizedBox(
                      width: 57.w,
                      child: Text(
                        widget.forRegisteredContest
                            ? "You have successfully registered for the contest"
                            : "Upcoming Weekly Contest. Don't miss your chance to compete and win",
