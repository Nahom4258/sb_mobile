    ...
    emit(
      homeContentOrFailure.fold(
        ...
        (homeEntity) => GetHomeState(
          ...
          coins: homeEntity.coin,
          rank: homeEntity.rank,
          referralCount: homeEntity.refferalCount,
          totalUsers: homeEntity.tottalUserCount,
          totalUnseenNotifications: homeEntity.totalUnseenNotifications
        ),
      ),
    );
  }
