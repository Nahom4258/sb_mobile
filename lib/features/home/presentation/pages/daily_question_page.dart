...
class _DailyQuestionPageState extends State<DailyQuestionPage> {
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), (timer) {
      if (_countDownDuration > 0) {
        ...
        if (widget.dailyQuestionPageParams.questionMode == QuestionMode.quiz) {
          showPopupWhenCountdownEnds(context: context, onPressed: () {
            context
  ...
  void showPopupOnCompletingContest(BuildContext context) {
    showDialog(
        context: context,
            ...
            title: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  AppLocalizations.of(context)!.completed_successfully,
  ...
  // void showPopupWhenCountdownEnds(BuildContext context) {
  //   showDialog(
  //     context: context,
  //     barrierDismissible: false,
  //     builder: (_context) {
  ...
  //         title: Text(
  //           // 'Time Expired',
  //           AppLocalizations.of(context)!.time_expired,
  //           style: GoogleFonts.poppins(color: Colors.red),
  //         ),
  //         content: Text(
  //           // 'You have run out of time to answer the question.',
  //           AppLocalizations.of(context)!.you_have_run_out_of_time_to_answer_the_question,
  //           style: GoogleFonts.poppins(),
  //         ),
  //         actions: [
  //           TextButton(
  ...
  // void showPopupOnQuitButtonPressed(BuildContext context) {
  //   showDialog(
  //     context: context,
  //     barrierDismissible: false,
  //     builder: (_context) {
